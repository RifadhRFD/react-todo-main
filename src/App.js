...
const style = {
  ...
  head: `text-3xl font-bold text-center text-gray-800 p-2`,
  form: `flex justify-between`,
  input: `w-full p-2 border text-xl rounded-md`,
  ...
  return (
    <div className={style.bg}>
      <div className={style.container}>
        <h3 className={style.head}>Todo App</h3>
